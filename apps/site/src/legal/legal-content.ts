...
/** Dedicated privacy / data-subject-request mailbox (route it to the maintainers). */
const PRIVACY_CONTACT = 'privacy@mcpfold.com';
...
export const LEGAL_DOCS: readonly LegalDoc[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          `For any privacy or data-protection question, or to exercise a data-subject right, email our dedicated privacy contact at ${PRIVACY_CONTACT}. This policy is versioned and dated (see the effective date above); material changes will update the version. You can also open an issue on ${GITHUB}.`,
        ],
      },
    ],
  },
